odoo.define('website_quotation_product_substitute.website_quotation_product_substitute', function (require) {
'use strict';
...
// if(!$('.o_website_quotation_product_substitute').length) {
//     return $.Deferred().reject("DOM doesn't contain '.o_website_quotation_product_substitute'");
// }
    ...
    //         var line_id = href.match(/substitute_line\/([0-9]+)/);
